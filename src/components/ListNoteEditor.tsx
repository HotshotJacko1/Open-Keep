  ...
  return (
    ...
    >
      ...
      <Input
        ...
        className="flex-1 bg-white text-white border-gray-700"
      />
      <Button
        variant="ghost"
        size="icon"
...
const ListNoteEditor: React.FC<ListNoteEditorProps> = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleCloseEditor}>
      <DialogContent className="sm:max-w-[425px] md:max-w-[600px] lg:max-w-[800px] bg-white text-[#4f4f4f]">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-2 mt-2">
              <Input
                ...
                className="bg-white text-[#4f4f4f] border-gray-700"
              />
