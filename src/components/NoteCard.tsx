    ...
    >
      ...
      >
        <div className={cn(
          ...
          {!isSelected && <span className="h-4 w-4 text-secondary-foreground hover:text-secondary-foreground hover:dark:text-secondary-foreground" />} {/* Placeholder to keep size */}
        </div>
      </div>
