    ...
    >
      ...
      >
        <div className={cn(
          ...
          {isSelected && <Check className="h-4 w-4 text-secondary dark:text-secondary group-hover:text-transparent" />}
          {!isSelected && <Check className="h-4 w-4 hover:text-black hover:dark:text-secondary-foreground" />} {/* Placeholder to keep size */}
        </div>
      </div>
