...
const NoteCard: React.FC<NoteCardProps> = ({
  ...
  return (
    <Card
      className={cn(
        "group inline-block w-full relative break-inside-avoid-column mb-4 hover:shadow-lg transition-shadow duration-200 bg-foreground dark:bg-foreground text-secondary-foreground cursor-pointer border-2 border-input select-none overflow-hidden",
